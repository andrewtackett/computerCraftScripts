...
function findLastOpenInventorySlot(inventory_size, items)
...
function restockItem(desired_item_name, needed_items)
...
function navigateToRowStartFromChest()
...
function navigateToChestFromRowStart()
...
function navigateToRowStartFromEnd()
